 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTPLUGIN_ROVER_HH_
#define GAZEBO_PLUGINS_ARDUPILOTPLUGIN_ROVER_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE ArduPilotPlugin_Rover : public ModelPlugin
  {
    /// \brief Constructor.
    public: ArduPilotPlugin_Rover();
